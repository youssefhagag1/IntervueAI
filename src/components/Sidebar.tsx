...
const actualBar = (path: string) => (
  <div className="w-64 sticky top-17.5 h-[calc(100vh-70px)] py-3 border-r border-gray-200 hidden lg:flex flex-col">
    <Link
      href="/interview"
...
const MobileSidebar = (path: string) => (
  <div className="w-15 sticky top-17.5 h-[calc(100vh-70px)] py-3 border-r border-gray-200 lg:hidden flex flex-col">
    <Link
      href="/interview"
      className="flex bg-primary rounded-sm p-3 m-2 outline-2 outline-offset-2 outline-dashed mb-5 text-white items-center gap-3 hover:bg-primary/90"
    >
