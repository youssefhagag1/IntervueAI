...
function Interview() {
  ...
  const handleStartInterview = async () => {
    ...
    try {
      const id = await startInterviewAction(
        interviewType,
        numberQuestions,
        jobRole,
        company,
            ...
            {interviewTypes.map((type) => {
              ...
              return (
                <li
                  ...
                  className={`flex flex-col items-center justify-center gap-4 p-8 border rounded-md border-gray cursor-pointer group ${
                ...
                >
                  <span
                    className={`group-hover:text-primary ${
                      interviewType === type.label && "text-primary"
                    }`}
                  >
                    <Icon />
                  </span>
            ...
            <ul className="flex gap-2 md:gap-3">
              {[5, 10, 15, 20].map((num) => (
                <li
                  ...
                  className={`cursor-pointer flex-1 h-15 flex items-center justify-center text-center border border-gray text-gray rounded-sm ${
                    num === numberQuestions
